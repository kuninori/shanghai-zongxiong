<template>
  <fa-layout :ch="true" current="news">
    <div class="news-page">
      <div class="inner">
        <div class="title">NEWS</div>
        <div class="list">
          <div class="item">
            <div class="item-title">ウェブサイトをリニューアルいたしました。</div>
            <div class="item-date">2021.2.20</div>
            <p class="item-body">この度、ウェブサイトを全面リニューアルいたしました。<br/>
            内容の充実を図るとともに、最新の情報を発信してまいりますので、今後ともよろしくお願い致します。</p>
            <a class="item-link" href="/news/001">詳しくはこちら</a>
          </div>
        </div>
        <!--
        <div class="nav">
          <div class="nav-prev">&lt;&lt;戻る</div>
          <div class="nav-nums">
